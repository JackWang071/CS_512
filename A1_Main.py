...
#A1_Defs.PrintMatrix(Matrix1) #this is just for testing
...
#A1_Defs.PrintMatrix(Matrix2) #this is just for testing

Matrix3 = A1_Defs.AddingMatrices(Matrix1, Matrix2)
#A1_Defs.PrintMatrix(Matrix3) #this is just for testing

Matrix4 = A1_Defs.AddingContentOfEachRow(Matrix3)
#A1_Defs.PrintMatrix(Matrix4) #this is just for testing
